<?php /* Smarty version 2.6.18, created on 2013-02-14 14:21:14
         compiled from Dataface_Login_Prompt.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'use_macro', 'Dataface_Login_Prompt.html', 1, false),array('block', 'fill_slot', 'Dataface_Login_Prompt.html', 2, false),array('block', 'define_slot', 'Dataface_Login_Prompt.html', 19, false),array('block', 'translate', 'Dataface_Login_Prompt.html', 20, false),array('function', 'block', 'Dataface_Login_Prompt.html', 18, false),array('function', 'actions', 'Dataface_Login_Prompt.html', 44, false),)), $this); ?>
    <?php $this->_tag_stack[] = array('use_macro', array('file' => "Dataface_Main_Template.html")); $_block_repeat=true;$this->_plugins['block']['use_macro'][0][0]->use_macro($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
       ...
       <?php $this->_tag_stack[] = array('fill_slot', array('name' => 'html_body')); $_block_repeat=true;$this->_plugins['block']['fill_slot'][0][0]->fill_slot($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?> <!-- probably the most impotant line here-->
       <div style="width:500px; padding-top:100px; margin-left:auto; margin-right:auto;">
       <div style="width:330px; margin-left:auto; margin-right:auto;"><img src="" /></div>
