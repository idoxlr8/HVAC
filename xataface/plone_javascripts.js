...
function updatetotal() {
	...
	//combine parts totals//
	partsttl = (document.getElementById('item1cost').value -0) + (document.getElementById('item2cost').value -0) + (document.getElementById('item3cost').value -0)
 + (document.getElementById('item4cost').value -0) + (document.getElementById('item5cost').value -0) + (document.getElementById('item6cost').value -0) + (document.getElementById('item7cost').value -0)
  + (document.getElementById('item8cost').value -0) + (document.getElementById('item9cost').value -0);
  document.getElementById('partstotal').value = formatCurrency(partsttl);
  
	
	//combine labor totals//
	//document.getElementById('labortotal').value = (document.getElementById('labor1cost').value -0) + (document.getElementById('labor2cost').value -0) + (document.getElementById('labor3cost').value -0);
	laborttl = (document.getElementById('labor1cost').value -0) + (document.getElementById('labor2cost').value -0) + (document.getElementById('labor3cost').value -0);
	document.getElementById('labortotal').value = formatCurrency(laborttl);

	//combine tax variables//
	if (document.getElementById('labortaxable').value == "yes")
		{
			//var partstax = formatCurrency((document.getElementById('partstotal').value -0) *.0825);
			labortax = formatCurrency((document.getElementById('labortotal').value -0) *.0825);
			taxtotal = labortax;
			document.getElementById('tax2').value = taxtotal;
		}
	else
		{
		document.getElementById('tax2').value = "0.00";
		}
		
	if (document.getElementById('partstaxable').value == "yes")
		{
			partstax = formatCurrency((document.getElementById('partstotal').value -0) *.0825);
			//labortax = formatCurrency((document.getElementById('labortotal').value -0) *.0825);
			taxtotal2 = partstax;
			document.getElementById('tax1').value = taxtotal2;
		}
	else
		{
			document.getElementById('tax1').value = "0.00";
		}

	//combine parts, labor into subtotal//
	subttl = (document.getElementById('labortotal').value -0) + (document.getElementById('partstotal').value -0);
	document.getElementById('subtotal').value = formatCurrency(subttl);
	
	taxttl = (document.getElementById('tax1').value -0) + (document.getElementById('tax2').value -0);
	document.getElementById('tax').value = formatCurrency(taxttl);
	
	//combine sub total and tax for total//
	grndttl = (document.getElementById('tax').value -0) + (document.getElementById('subtotal').value -0);
	document.getElementById('total').value = formatCurrency(grndttl);
}
...
function updateSelected(tableid){var ids=getSelectedIds(tableid);if(ids.length==0){alert("Please first check boxes beside the records you wish to copy, and then press 'Copy'.");return;}
var form=document.getElementById("result_list_selected_items_form");form.elements['--selected-ids'].value=ids.join("\n");form.elements['-action'].value='copy_replace';form.submit();}
function removeSelectedRelated(tableid){var ids=getSelectedIds(tableid);if(ids.length==0){alert("Please first check boxes beside the records you wish to copy, and then press 'Copy'.");return;}
