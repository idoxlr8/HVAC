...
$day0 = $parsed_json->{'forecast'}->{'txt_forecast'}->{'forecastday'}[0]->{'title'};
$day1 = $parsed_json->{'forecast'}->{'txt_forecast'}->{'forecastday'}[1]->{'title'};
echo "Day : $day1\n"; 
//////////////////
...
//$day3 = $parsed_json->{'forecast'}->{'txt_forecast'}->{'forecastday'}[3]->{'title'};
